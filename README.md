...
`Bn 06 vv`|RPN Data Entry MSB|vv = Value
...
`Bn 26 vv`|RPN Data Entry LSB|vv = Value
...
* OmniSerial (eventually), [Hairless MIDI<->Serial Bridge](https://github.com/tyan0/hairless-midiserial/releases), or [Arduino MIDI Driver](https://github.com/DevanWolf/Arduino-MIDI-Driver/releases/download/1.0/Arduino_USB_Serial_MIDI_Driver_Win32.zip) (based on KAWAI GMegaRSNT. Windows 32-bit only)

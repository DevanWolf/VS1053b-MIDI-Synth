		...
		if (data >> 5 == 4 or data >> 4 == 11 or data >> 4 == 12 or data >> 4 == 14 or data == 0xF0) {
			...
			if (cmd >> 5 == 4 or cmd >> 4 == 11 or cmd >> 4 == 12 or cmd >> 4 == 14) {
				if (value < 0 and cmd >> 5 != 6) value = data;
					...
					if (!(cmd >> 4 == 11 and ((value >= 1 and value <= 5) or value == 8 or value == 9 or (value >= 13 and value <= 37) or (value >= 39 and value <= 63) or value == 65 or (value >= 67 and value <= 90) or (value >= 92 and value <= 97) or (value >= 102 and value <= 119) or value == 122 or value >= 126))) { // filter out unassigned CCs
			...
			if (data == 0xF7 and cmd == 0xF0) {
				if (sysex[1] == 0x7F) {
					...
					else if (sysex[3] == 2) writeRegisterSplit(2, sysex[5], sysex[4]);

 ...
 * - MOSI: Pin 11
 * - SCK: Pin 13
 * - DREQ: Pin A1 (not used)
 * - XRST: Pin A0
 * - XCS: Pin A3
 * - XDCS: Pin A2
 *
 * Software:
 * - Hairless MIDI<->Serial (Win/Mac) (https://github.com/tyan0/hairless-midiserial/releases)
 * - MIDI Yoke NG (for Windows users) (https://www.hermannseib.com/programs/myokeng.exe)
 * Linux users: setserial /dev/ttyS0 uart none && modprobe snd-serial-u16550 port=0x3f8 irq=4 speed=115200
 *
